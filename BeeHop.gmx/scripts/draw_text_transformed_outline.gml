///draw_text_transformed_outline(x,y,str,outwidth,outcol,outfidelity, scale, angle)
...
{
    draw_text_transformed(argument0+lengthdir_x(argument3,dto_i),argument1+lengthdir_y(argument3,dto_i),argument2, argument6, argument6, argument7);
}

draw_set_color(dto_dcol);

draw_text_transformed(argument0,argument1,argument2, argument6, argument6, argument7);
