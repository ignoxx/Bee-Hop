        ...
        case 0:
            repeat(ds_list_size(_tweens)){
                ...
                if (_target == _selectionData || _target.object_index == _selectionData || object_is_ancestor(_target.object_index, _selectionData)){
                    if (TGMS_TargetExists(_target)) script_execute(_script, _t);
                }
            }
        break;
        case 1:
            repeat(ds_list_size(_tweens)){
                ...
                var _target = _t[TWEEN.TARGET];
                if (_target == _selectionData || _target.object_index == _selectionData || object_is_ancestor(_target.object_index, _selectionData)){
                    if (TGMS_TargetExists(_target)) script_execute(_script, _t, _arg0);
                }
            }
        break;
        case 2:
            repeat(ds_list_size(_tweens)){
                ...
                var _target = _t[TWEEN.TARGET];
                if (_target == _selectionData || _target.object_index == _selectionData || object_is_ancestor(_target.object_index, _selectionData)){
                    if (TGMS_TargetExists(_target)) script_execute(_script, _t, _arg0, _arg1);
                }
            }
        break;
        case 3:
            repeat(ds_list_size(_tweens)){
                ...
                var _target = _t[TWEEN.TARGET];
                if (_target == _selectionData || _target.object_index == _selectionData || object_is_ancestor(_target.object_index, _selectionData)){
                    if (TGMS_TargetExists(_target)) script_execute(_script, _t, _arg0, _arg1, _arg2);
                }
            }
        break;
        }
